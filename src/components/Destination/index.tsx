  ...
  return (
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 grid-rows-1 items-center space-y-4 gap-4  ">
        ...
        <Slider 
          ...
          {
            href:"/servicedetail/dubai" , image:dubai, flag:dubaiflag ,visatype:"Official Drop Box Centre", title:"Dubai Visa", description:"Dubai is a city and emirate in the United Arab Emirates (UAE) located on the southeastern coast of the Persian Gulf."
          },
          ]}
        />   
        </div>
