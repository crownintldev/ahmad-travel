...
const About = () => {
  return (
    ...
    title={"About us"}
    image={aboutimage}
      para1={"Crown International Travels (Pvt)Ltd. was Established in 1990 by Mr. Nazir Ahmed(Late), our family-run company has been providing a variety of travel and tourismservices for more than 34 years. In 2007, Crown International Travels was became private limited company. As IATA Travel Agency We are authorized to announcethat Crown International Travels provides doorstep service at the lowest ratespossible for all Kinds of international & Domestic Airline Tickets."}
