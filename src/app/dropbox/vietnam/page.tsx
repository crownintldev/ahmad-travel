  ...
  return (
    <>
      <HeadPage
        ...
        title="Vietnam Visa"
        text="We Are Officially Authorized Vietnam Dropbox"
        ...
        <div className=" grid grid-cols-1 md:grid-cols-5 mt-10  md:gap-5">
          <div className="col-span-4">
            <div className="w-full space-y-3 mt-10">
              {dropvietnam.length > 0 &&
                dropvietnam.map((faq, outerIndex) => (
                  <div
                    key={faq.id || outerIndex}
                    className="bg-primary-orange-200 text-black rounded-md duration-500 transition"
                  >
                    <button
                    ...
                    >
                      ...
                      <IoIosArrowDropdownCircle
                        className={`h-6 w-6 text-white transform transition-transform ${
                          openIndex === outerIndex ? "rotate-180" : ""
                        }`}
                      />
                    </button>
                    <div
                      className={`p-5 border-t border-gray-200 transition bg-white shadow-lg duration-500 space-y-3 ease ${
                        openIndex !== outerIndex ? "hidden" : ""
                      }`}
                    >
